...
---@param ranges vim.treesitter.ByteRange[] Sorted, non-overlapping.
...
---@param range vim.treesitter.ByteRange
---@param edit_b integer
---@param edit_e_old integer
...
---None of the ranges are 0-width.
---@param a_beg integer Begin byte of range a.
---@param a_end integer End byte of range a.
---@param b_beg integer Begin byte of range b.
---@param b_end integer End byte of range b.
function M.intersects(a_beg, a_end, b_beg, b_end)
  return a_beg < b_end and b_beg < a_end
end
